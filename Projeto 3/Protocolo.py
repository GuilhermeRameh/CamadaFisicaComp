...
class Protocolo:
   ...
   # com uma lista, em que cada elemento da lista é um pacote com 114 bytes
    ...
    def montaDatagrama(self, idPacote, pkgSize, pkgTotalSize, receiverId, resendBit, continueBit, formato, package):
    ...
    def sendingLoop(self, packages, formato):
        ...
        for i in range(len(packages)):
            ...
            txBuffer = self.montaDatagrama(idPacote, pkgSize, pkgTotalSize, reciverId, b'\x00', b'\x00', formato, package)
    ...
    def receivingLoop(self):
        ...
        while receiving:
            ...
            payloadSize = bufferHead[2 - 1]
            nPacotes = bufferHead[3-1:4-1]
            ...
            bufferEOP, nBufferEOP = self.getData(4)
    ...
    def sendHandshake(self):
        startTime = time.time()
        send = True
        handShake = self.montaDatagrama(b'\x00', b'\x00', b'\x00', b'\x69', b'\x00', b'\x00', b'\x00\x00\x00', b'')
        while send:
